...
(function() {
  ...
  db.put('ä', 'ä', function(error, result) {
    if (error != null) {
      throw error;
    }
  ...
  keys = [[0x30], [0x31], [0x32], [0x41], [0x42], [0x43], [0x61], [0x62], [0x63], [0x7e], [0xc3, 0xa4], [0xc3, 0xbf], [0xce, 0x98], [0xe4, 0xb8, 0xad], [0xf0, 0xa0, 0x80, 0x80], [0xf4, 0x8f, 0xbf, 0xbd], [0xff]];
